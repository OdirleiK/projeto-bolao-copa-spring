...
public class BolaoResource {
	...
	@PostMapping
	public ResponseEntity<BolaoDTO> insert(@Valid @RequestBody BolaoDTO dto) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<BolaoDTO> update(@PathVariable Long id, @Valid @RequestBody BolaoDTO dto) {
